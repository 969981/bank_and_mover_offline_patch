...
#define FSUSER_HANDLE_SLOT ((volatile u32 *)0x00311F80u)
#define FSUSER_OPEN_FILE_DIRECTLY ((FsOpenFileDirectly)0x001DF448u)
#define FSFILE_WRITE ((FsFileWrite)0x00159390u)
#define FSFILE_CLOSE ((FsFileClose)0x00159364u)
